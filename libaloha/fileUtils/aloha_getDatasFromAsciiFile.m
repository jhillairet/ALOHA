function [S_plasma, rac_Zhe] = aloha_getDatasFromAsciiFile(filename, S_plasma, rac_Zhe, Nme, Nmh, nb_g_pol, nb_g_total_ligne, D_guide_max, ind,type_swan_aloha, architecture, freq)
...
% 
    ...
    % Waveguide impedance definition is not the same for the two code:
    %  - in SWAN, this is parallel plate waveguide
