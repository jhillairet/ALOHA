...
from aloha.utils import load_matlab_mat_file, parse_matlab_array
...
class TestUtils(unittest.TestCase):
    ...
    def test_load_mat_files(self):
        ...
        mat_files = [
            MATLAB_TEST_CASES_DIR / "8_active_waveguides" / "scenario_simple.mat",
            MATLAB_TEST_CASES_DIR / "WEST_LH1" / "scenario_WEST_LH1.mat",
            MATLAB_TEST_CASES_DIR / "WEST_LH2" / "scenario_WEST_LH2.mat",
        ]

        for mat_file in mat_files:
            scenario_dict, results_dict = load_matlab_mat_file(mat_file)
