...
C Boucle sur les differents guides
	 ...
	 write(*,*) 'K=',((Y(ind_i,ind_j),ind_i=1,3),ind_j=1,3)
	 write(*,*) X0,D0
...
C      Write (*,*) 'pre=',(pre(i),i=1,Pg)
      Write (*,*) 'mh=',(mhi(1,i),i=1,Nmh)
      Write (*,*) 'nh=',(mhi(2,i),i=1,Nmh)
...
C ***
      ...
      Do 100 i=1,Nmh
         RZh(i)=CDSQRT(Z0/CDSQRT((1.,0.)*(1-(kch(i)/k0)**2)))
         RYh(i)=1/RZh(i)
 100  Continue
...
C ***
      ...
      Do 100 i=1,Nme
         RZe(i)=CDSQRT(Z0*CDSQRT((1.,0.)*(1-(kce(i)/k0)**2)))
         RYe(i)=1/RZe(i)
 100  Continue
