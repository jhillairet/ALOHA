...
C                functions Dv(x) and their derivatives
C                
...
C                PDD --- Dv'(x)
        ...
        SUBROUTINE PARABOLIC_D(V,X,PDF,PDD)

        implicit none

        Integer *4 NV,NA
        Real *8 V,X,PDF,PDD,V0,DV(0:100),DP(0:100)
...
C
        ...
        Integer *4 NV,NA,JA,L,K,NK,M
        Real *8 V,X,DV(0:*),DP(0:*),PDF,PDD,XA,VH,V0,EP,PD0,PD1,V1,PD,V2
        Real *8 F1,F0,F,S0
...
C
        ...
        Integer *4 M
        Real *8 VA,X,PD,EPS,PI,SQ2,EP,VA0,GA0,G1,G0,VT,A0,R,VM,GM,R1
...
C
        ...
        Integer *4 K
        Real *8 VA,X,PD,EPS,PI,EP,A0,R,X1,VL,GL
...
C
        ...
        Integer *4 K
        Real *8 VA,X,PV,EPS,PI,QE,A0,R,X1,PDL,GL,DSL
