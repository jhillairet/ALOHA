...
c Declaration de variable
     ...
     &ys_zy_stok_sp,ys_zz_stok_sp
      ...
      Common/quad/nz_quad,error,quad_key
      ...
      Real *8 nz_quad,distance,lambda,error
      Complex *16 K
...
c intégration
     ...
     &                      hy_ny_nz,hz_ny_nz,int_sp,num)    
      ...
      Real *8 borne_max,demi_intervalle,error
     ...
     &        neval,ier,limit,lenw,last,iwork,work)
      ...
      Real *8 borne_max,demi_intervalle,error,nz_quad
