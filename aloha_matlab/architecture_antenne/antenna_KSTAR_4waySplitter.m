...
%% --------------------------------------
%  Antenna name
antenna_lh.name = 'KSTAR Grill antenna - 4 ways splitter assembly';
...
% There is 2kinds of RF design, and reversed upside down like this:
% Stb : Straight bottom feeding
% Sbb : Sbend bottom feeding
% Stt : Straight top feeding
% Sbt : Sbend top feeding
%
% view from the plasma : 
%
% Stb Sbb Sbt Stt Stb Sbb Sbt Stt 
filenames = strvcat('KSTAR_4way_splitter_Straight_Top', ...
                    'KSTAR_4way_splitter_Sbend_Top', ...
                    'KSTAR_4way_splitter_Sbend_Bottom', ...
                    'KSTAR_4way_splitter_Straight_Bottom', ...
                    'KSTAR_4way_splitter_Straight_Top', ...
                    'KSTAR_4way_splitter_Sbend_Top', ...
                    'KSTAR_4way_splitter_Sbend_Bottom', ...
                    'KSTAR_4way_splitter_Straight_Bottom');
...
modules.Sparameters.phase_deembedded = ([0 198.9, 202.5, 3.2, 0 198.9, 202.5, 3.2])*pi/180; 
