...
%% --------------------------------------
%  Antenna name
antenna_lh.name = 'KSTAR PAM antenna with 4 active waveguides module';
...
%  modules.Sparameters.pathTo = 'S_HFSS/matrices_HFSS_ITER';  % path the S-matrix files (.m files) 
%  filenames = repmat('LH4Iter_4activeswg', modules.nma_phi, 1);  

modules.Sparameters.pathTo = 'matrices_HFSS_elem'; 
filenames = repmat('S_elem', modules.nma_phi, 1); 
...
modules.phase = 0*(pi/180)*(0:modules.nma_phi-1)';
