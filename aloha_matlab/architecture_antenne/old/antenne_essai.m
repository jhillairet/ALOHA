...
nom_fichiers =  ['mult_jonct_SWAN';'mult_jonct_SWAN';'mult_jonct_SWAN';'mult_jonct_SWAN';'mult_jonct_SWAN';'mult_jonct_SWAN';...
                 'mult_jonct_SWAN';'mult_jonct_SWAN';'mult_jonct_SWAN'];
