...
modules.Sparameters.pathTo = [aloha_utils_getRootPath,'/S_HFSS/matrices_HFSS_Simple_Antenna'];  % path the S-matrix files (.m files) 

% Here I assume all the S matrices are the same for all modules
filenames = repmat(['S_1active_wg1'], modules.nma_phi, 1);
