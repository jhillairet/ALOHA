...
antenne_standard = 1; % = 0 il faut décrire l'antenne sur une ligne : tableaux b et e  
                      % = 1 paramètres scalaires : b_g_actif, b_g_pass et e
...
nom_fichiers = ['S_C3_24b'];

% multi_jonction 1x6
% nom_fichiers =  ['mult_jonct_SWAN'];
...
T_grill = 1;                % périodicité du grill / diminue les tps de calcul
