function splitc = splitcodef(code)
%Split a line of Fortran code in string, comment and other
%  SPLITC = SPLITCODE(CODE) splits line of Fortran code CODE into a cell
