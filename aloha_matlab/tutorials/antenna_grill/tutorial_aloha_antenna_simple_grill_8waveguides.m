...
%% --------------------------------------
%  Antenna name
antenna_lh.name = 'One row of 8 phased waveguides side-by-side';
...
modules.Sparameters.pathTo = '';  % path the S-matrix files (.m files) 

filenames = repmat(['tutorial_aloha_Selem'], modules.nma_phi, 1);
