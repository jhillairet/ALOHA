...
nb_modules_tor = 1;	% nbre de modules sur une ligne poloidale - number of modules in a row
...
lcc = 1/4*ones(1, length(pass_module_tor)+2*nb_g_passifs_bord);
...
% modules       
nom_fichiers = ['PAM_TOPLHA';'PAM_TOPLHA';'PAM_TOPLHA';'PAM_TOPLHA';'PAM_TOPLHA';'PAM_TOPLHA';'PAM_TOPLHA';'PAM_TOPLHA'];   
