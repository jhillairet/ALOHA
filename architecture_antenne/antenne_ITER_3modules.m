...
nb_modules_tor = 3;		% nbre de modules sur une ligne poloidale 
...
% modules
% nom_fichiers = ['LH4Iter_module';'LH4Iter_module';'LH4Iter_module'];   

 nom_fichiers = ['LH4Iter_module_longVersion_58mm';'LH4Iter_module_longVersion_58mm';'LH4Iter_module_longVersion_58mm'];   
%  nom_fichiers = ['LH4Iter_module_shortVersion';'LH4Iter_module_shortVersion';'LH4Iter_module_shortVersion'];   
%  nom_fichiers = ['LH4Iter_module_longVersion_comsol';'LH4Iter_module_longVersion_comsol';'LH4Iter_module_longVersion_comsol'];   
